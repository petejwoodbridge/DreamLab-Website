...
window.dreamlab_CONTENT = {
  ...
  team: [
    {
      ...
      categories: ['ai', 'workflows', 'product', 'realtime', 'virtual-production', 'application', 'training', 'creative', 'data', 'unreal', 'comfyui'],
    ...
    },
    {
      ...
      categories: ['creative', 'workflows', 'film', 'design', 'training', 'animation', 'virtual-production', 'immersive'],
    ...
    },
    {
      ...
      categories: ['creative', 'workflows', 'product', 'ai', 'realtime', 'virtual-production', 'film', 'application', 'training', 'design', 'data', 'technical-art', 'unreal', 'comfyui', 'immersive'],
      award: 'BIMA 100 · 2020',
    ...
    },
    {
      ...
      categories: ['ai', 'workflows', 'data', 'creative', 'training', 'comfyui'],
    ...
    },
    {
      ...
      categories: ['product', 'design', 'data', 'application', 'film', 'creative', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'virtual-production', 'creative', 'training', 'ai', 'immersive'],
    ...
    },
    {
      ...
      categories: ['creative', 'film', 'training', 'music'],
    ...
    },
    {
      ...
      categories: ['creative', 'design', 'music', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'animation', 'training', 'creative', 'film', 'immersive'],
    ...
    },
    {
      ...
      categories: ['data', 'product', 'application', 'workflows'],
    ...
    },
    {
      ...
      categories: ['creative', 'realtime', 'virtual-production', 'design', 'product', 'technical-art', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['virtual-production', 'realtime', 'film', 'creative', 'product', 'animation', 'technical-art', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['ai', 'creative', 'data', 'design', 'application', 'comfyui'],
    ...
    },
    {
      ...
      categories: ['virtual-production', 'creative', 'film', 'training', 'realtime', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'virtual-production', 'film', 'animation', 'design', 'creative', 'technical-art', 'unreal'],
    ...
    },
    {
      ...
      categories: ['creative', 'realtime', 'virtual-production', 'design', 'training', 'technical-art', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['virtual-production', 'creative', 'film', 'training', 'animation', 'realtime', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'virtual-production', 'creative', 'product', 'application', 'animation', 'training', 'technical-art', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'creative', 'workflows', 'application', 'film', 'animation', 'design', 'immersive'],
    ...
    },
    {
      ...
      categories: ['creative', 'realtime', 'virtual-production', 'training', 'immersive'],
    ...
    },
    {
      ...
      categories: ['realtime', 'virtual-production', 'film', 'creative', 'design', 'technical-art', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['ai', 'realtime', 'virtual-production', 'creative', 'product', 'application', 'training', 'unreal', 'immersive'],
    ...
    },
    {
      ...
      categories: ['product', 'realtime', 'application', 'creative', 'training', 'music', 'immersive'],
    ...
    },
    {
      ...
      categories: ['product', 'creative', 'immersive'],
    },
    {
      ...
      categories: ['product', 'application', 'creative', 'immersive'],
    },
    {
    ...
    },
    {
      ...
      categories: ['creative', 'virtual-production', 'product', 'immersive'],
    },
    {
    ...
    },
    {
      ...
      categories: ['creative', 'realtime', 'virtual-production', 'ai', 'workflows', 'product', 'film', 'technical-art', 'comfyui', 'immersive'],
  ...
  // ──────────────────────────────────────────────────────────
  sectors: [
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="13" rx="5"/><path d="M9 11v4m2-2H7"/><path d="M17 12h.01M15 14h.01"/></svg>', name: 'Games', description: 'Interactive entertainment, indie development, game engines, esports technology and gaming innovation.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="8" width="20" height="13" rx="2"/><path d="M2 12h20M7 8V4m5 4V4m5 4V4"/></svg>', name: 'Film & TV', description: 'Virtual production, immersive storytelling, visual effects pipelines and broadcast technology.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>', name: 'Music', description: 'Interactive audio, AI music tools, immersive sound design and music technology innovation.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4z"/></svg>', name: 'Animation', description: 'Real-time animation, AI-assisted production, procedural content and digital characters.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>', name: 'Health', description: 'VR therapeutics, medical visualisation, patient education and AI-powered health tools.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 10l10-5 10 5-10 5z"/><path d="M6 12.5V17c0 1.657 2.686 3 6 3s6-1.343 6-3v-4.5"/><line x1="20" y1="10" x2="20" y2="16"/></svg>', name: 'Education', description: 'Immersive learning experiences, AI tutoring, skills training platforms and EdTech innovation.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 3L9 8H5a2 2 0 000 4h1l2 7h3l-1-6h0l10 4V3z"/></svg>', name: 'Marketing & Advertising', description: 'Creative AI campaigns, interactive brand experiences, generative content and experiential marketing.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M3.6 9h16.8M3.6 15h16.8"/><path d="M12 3c-3 4-4 6-4 9s1 5 4 9m0-18c3 4 4 6 4 9s-1 5-4 9"/></svg>', name: 'Creator Economy', description: 'Tools and platforms empowering independent creators with AI, interactivity and emerging technology.' },
    { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>', name: 'Performance & Live', description: 'Real-time visuals, interactive installations, live event technology and performative tech.' },
  ],
